...
- **INT:** 14
- **CHA:** 10
- **Key Skills:** Fly, Knowledge (Geography), Perception
...
## Signature Abilities
- **Trajectory Mapping** — Could calculate orbital mechanics and flight paths in her head with supernatural precision. She once corrected a launch vector mid-flight using nothing but mental arithmetic and instinct — instinct that felt older than she was.
- **Emergency Protocols** — Drilled her crew relentlessly in crash-landing procedures, always insisting on one rule: "The pilot is the last to leave." She followed this rule to her death.
- **Deadstick Landing** — Her legendary technique for bringing unpowered craft down safely. She managed it three times on the rebuilt shuttle before the fourth and final attempt failed.

## Prized Possessions
- The shuttle's navigational crystal — a fist-sized piece of alien computing substrate that she carried on her person at all times. When she held it, she could feel faint traces of stellar coordinates that no one on Golarion should know.
- A flight jacket stitched from alien-fiber cloth, impossibly light and warm. Her crew had embroidered their names on the inside lining. She was buried in it.

## One-Liners
- Orders must be followed without question.
- The weight of command is heavy indeed.
- A pilot's duty is to protect, not to perish.
- Precision and discipline are the keys to success.
