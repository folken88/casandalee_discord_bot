---
title: "Player-Character Map"
type: meta
tags: ["meta", "players", "characters"]
...
| Hans | Maginnis | Original roster, retired ~Jan 2023, one guest return later. Gunslinger, pistol "Justice" |
| Harrison | Hirsek | Guest appearance only (tiefling mercenary) |
| Brent | Unknown | Brief guest, Hollywood stunt man, inconsistent attendance |
| Morgana's player | Morgana | Android wizard, 5th original player, quit early (pre-YouTube) |
| Toby | GM | All NPCs |

### Key NPCs
- Val Baine — Khonnir's adopted daughter, magus, lives in Torch
- Meyanda — android cleric (was Hellion's cleric, later ally)
- Sevroth — NPC ally
- Zuma — kasatha ranger NPC ally
- Isuma — kasatha survivor NPC ally
- Casandalee — AI goddess, the bot's namesake

### Enrique's Character Succession
1. **Gavrilo** — died (early sessions)
2. **Eldrin** — died (Choking Tower arc, killed by Furkas Xoud's ghost)
3. **Kroktah/Cckatha** — kasatha druid, died (~360 damage from Osman at Technic League compound)
4. **Mr Brow / Augustus Teabrow** — halfling psychic (current)

### Maginnis & Justice
- Hans played Maginnis (gunslinger) from Session 00 through ~Jan 2023
- Maginnis's pistol "Justice" landed the killing crit on Hellion
- Justice absorbed Hellion's divine energy → became divine-slaying (bane vs celestials and devils)
- Maginnis retired in "Family Drama" session, discovered revolver "Revenge"
- Returned for one guest session ("I thought he was a waiter" — mistook Mr Brow for a waiter)

### Tokala's Divine Arc
- Tracy plays Tokala (and sometimes Blackout)
- When Hellion exploded, Tokala absorbed escaping divine energy
- This severed Tokala's connection to Gorum (his deity)
- For months, Tokala couldn't connect to a consistent god
- Eventually realized he was connecting to a new, weakly-divine Casandalee
- Casandalee shared his hatred of the Technic League, Unity, and Hellion

## Skull & Shackles (SS)
| Player | Character(s) | Notes |
|--------|-------------|-------|
| Kip | Holden | Active |
| Daemon | Storgrim | Active |
| Enrique | Sha-Feng | Active (was decapitated, reincarnated as hobgoblin, has robotic arm) |
| Josh | Ser-Toche | Active |
| Tim | Vaughan | Active |
...
### Mayonese
- The SS party used the code word **"mayonnaise"** for mutiny while planning aboard the Wormwood
- This evolved into a full **sign language called "Mayonese"**
- All SS party members are fluent in it
- They use Mayonese **tactically in combat** for silent coordination
...
| Anna | Elfrip | |
| Josh | Dinvaya | |
| Mandi | Kate-Blackwood | |
| Chris | Rodney-Danger-Smith | |
| Harrison | Dismas | |
| Toby | GM | |
...
| Josh | Reese | |
| Chris | Bruce | |
| Charles | Jason | Cleric of Asmodeus |
| Betty | Freya Kusanagi | Samurai / Hellknight of the Rack |
| Toby | GM | |

## Common Auto-Caption Garbles
| Garbled | Correct | Campaign |
|---------|---------|----------|
| Alfred, Alred | Ulfred | IG |
| no math, no maths, Nam Cath | Nomkath | IG |
| old brain, auburn | Olbryn | IG |
...
## GM Notes
- Toby (Tobias Merriman) is GM for all 5 campaigns
- Sessions are on Thursdays, 7-10 PM Chicago time
- Tracy retires/unretires frequently across campaigns
- Brent is a Hollywood stunt man, plays occasionally when schedule allows
- Hans retired from IG due to life circumstances
