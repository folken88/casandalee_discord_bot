...
- **Spread across ~8000 years:** From the Rain of Stars (-4363) to her last body-death (4223). Big gaps are fine: dormancy, stasis, or lives lived in peace somewhere. We want 110+ lives **spread across the timeline** so different lives can speak to different eras.
...
So: all 113 **body** lives must end by 4223 (her last body death). The “current” Cass in 4717 is the AI-core, not a 114th life.
...
- All 113 body lives end by 4223; ascension (late 4717) is the AI-core becoming goddess, not a 114th life.

## Numbering

Life numbers are **chronological**: Life 1 = first in time (Cassula, Rain of Stars), Life 113 = last body life (Casandalee the oracle, killed 4223). The 111 lives in between (2–112) are ordered by birth year. Use `tools/renumber-personas-chronologically.js` if you add or change dates and want to restore chronological numbering.

## Designing the 111 lives (2–112)
...
- `--life N` processes only life N (2–112).
...
- **Continuity tools:** `check-persona-continuity.js` / `fix-persona-birth-years.js` enforce no overlap and no life past ascension (and last body life 4223).
